...
7777    format(40e10.3)
        str = 'helprank.out'
!	  open(7778,file='helprank')       !liqiang
        call create_files(str, 7778)
77      continue
...
5001  format(1x,i4,1x,a1,i3,1x,i2,22e11.3)
	...
	obj(mm)=help
	  ...
	  case(9) 
       ...
       iitel4 = iitel                     !liqiang
       iitel3(iitel + 1) = iitel     
       do mm = 1, iobj
          obj1(mm, iitel+1) = obj(mm)
       end do
	write(18012,8012) iitel, (obj(mm), mm=1,iobj)
        write(*,8012) iitel, (obj(mm), mm=1,iobj)
