	subroutine parasolunc2(iobj,igoc,nopt,icalml,istat, iprob,bbound,
     *	parname, ntot,omin,nobs,m,    iiname, inrhru, iinr,
     *isens,icalpar, isenspar, sensw, imet, npt1)
...
c	written by Ann van Griensven - University of California Riverside, april 2003
	...
	integer isenspar(4,isens), imet(nopt), npt1
...
!        npt1 = npt2
!        call cali_reduce(iobj, npt1)      !liqiang
!        call cali_reduce2(nopt, npt1)
	select case (istat)
	case (1)
	write(18011, *) 'Results using Xi squared statistics'
        write(*,*) omin,nobs,nopt,igoc,iprob,icalml,objflim,objfmin
	...
	write(*,*) 'CPU:',myid1,'objective function limit1',objflim
