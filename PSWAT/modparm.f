      ...
      real :: wshd_wstrs, wshd_nstrs, wshd_pstrs, wshd_tstrs
      double precision :: wshd_pup, wshd_pal, wshd_pas, wshd_rmp
      double precision :: wshd_ftotn, wshd_ftotp, wshd_fixn, wshd_dnit
      double precision :: wshd_hmn, wshd_rwn, wshd_hmp, wshd_rmn
      double precision :: wshd_plch, wshd_raino3, basno3f,  basno3i
      double precision :: basorgni, basorgnf, basminpi, basminpf
      double precision :: basorgpi, basorgpf,  wshd_fno3,  wshd_fnh3
      double precision :: wshd_forgn, wshd_fminp, wshd_forgp, sno3up
      double precision :: wshd_yldn, wshd_yldp, wshd_voln, wshd_nitn
      real :: wdpq, ffcb, ressedc, wof_p
      real :: sftmp, smtmp, smfmx, smfmn, timp, wgpq
      real :: wshd_resv, wshd_ressed, wdlpq, wtabelo
      real :: peakr, pndsedin, sw_excess, albday, wglpq, wdps
      ...
      real :: snoev, adj_pkr, n_updis, p_updis, nactfr, reactw
...
! mpi
      integer :: myid, nprocs, sum1, flg, hrusper, hruscan, wshdaaoo
      integer :: inum1per, flagr, lasthruper,  subbegin, subamount 
!      integer :: myid3, nprocs3 
      integer, dimension (:), allocatable :: alenbcast, apsumnrot
      integer, dimension (:), allocatable :: ahrusper, ahruscan
      integer, dimension (:), allocatable :: subtotga, totlasthruper
      integer, dimension (:), allocatable :: altotbegin, altotdur
      integer, dimension (:), allocatable :: lastsubarr
      integer, dimension (:), allocatable :: subbeginarr, subamountarr
      integer, dimension (:), allocatable :: wshd, wshd_new
      real, dimension (:,:), allocatable :: varoutf   
      real*8 :: time0, time_sub, time_ra
!      integer, dimension (:), allocatable :: iitel1
!      real, dimension (:,:), allocatable :: sens1
! date
...
! Modifications to Pesticide and Water routing routines by Balaji Narasimhan
      ...
      integer :: retimes, myid1, nprocs1, flg2, iitel2, iitel4,icalml2
      integer :: myid2,nprocs2,myid3,nprocs3
      integer :: npg1, npt2, mloop,subcomm, allocation
      integer, dimension (:), allocatable :: iitel1, iitel3, icalml1
      integer, dimension (:), allocatable :: iitelnum, iitelnum3
      real*8, dimension (:,:), allocatable :: sens1, obj1, xx1
      real*8 time1,time2,time3,time4
      integer, dimension (:), allocatable :: arr_begin, arr_amount
      integer, dimension (:), allocatable :: arr_begin3, arr_amount3
      integer, dimension (:), allocatable :: arr_begin4, arr_amount4
      integer, dimension (:), allocatable :: iitelnum4
      real, dimension (:), allocatable :: variimon2

      integer :: narg
      character(len=100) :: arg(25)
      real*8 brg(25)
      real*8, dimension (:,:), allocatable :: drg
      integer crg
      character(len=150) :: erg
