...
c  SPACE, AND COMPUTE THE CORRESPONDING FUNCTION VALUES
        ...
        do j = 1, nopt
         ...
         do i = 1, npt1
          ...
          if(myid1 == (i-1)/(npt1/nprocs1)) then   !liqiang
           do j = 1, nopt
            xx(j) = x(i,j)
            xxo = xx
           end do
...
!      write(*,*) 'CPU:',myid1,'xfz00=',xfz
      do i = 0, nprocs1 - 1
           call mpi_bcast(xfz(npt/nprocs1*i+1,1),npt/nprocs1,           &
     &               mpi_double_precision,i,mpi_comm_world,ierr)
      end do
!      write(*,*) 'CPU:',myid1,'xfz000=',xfz
      call mpi_allreduce(omin,omin,iobj,mpi_double_precision,           &  
     &                   mpi_min,mpi_comm_world,ierr)
!        write(*,*) 'CPU:',myid1,'after reduce omin=',omin
	vartot=0.
	do mm=1,igoc
...
6666    format(i5, 41e12.5)	
	  ...
	  xf(i)=xf(i)*vartot
        ...
        do i = 0, nprocs1 - 1
           call mpi_bcast(xf(npt/nprocs1*i+1),npt/nprocs1,              &
     &               mpi_double_precision,i,mpi_comm_world,ierr)
        end do
c	
...
!        write(*,*) 'CPU:',myid1,'before parasolu omin=',omin
...
!        write(*,*) 'CPU:',myid1,(x(i,1),i=1,6)
!        write(*,*) 'CPU:',myid1,'after parasolu omin=',omin
  301 continue
...
c
	...
	vartot=0.
!        write(*,*) 'CPU:',myid1,'varobj=',varobj,'nobs=',nobs
!        write(*,*) 'CPU:',myid1,'ominn=',omin
	do mm=1,igoc
	varobj(mm)=omin(mm)/nobs(mm)
	vartot=vartot+varobj(mm)
	end do
...
667	format(100e12.5)
!        write(*,*) 'CPU:',myid1,'xfn=',xf
!        write(*,*) 'CPU:',myid1,'xfzn=',xfz
!       write(*,*) 'CPU:',myid1,'ixn=',varobj
        do i=1, npt1
...
!        write(*,*) 'CPU:',myid1,(x(i,1),i=1,6)
!        write(*,*) 'CPU:',myid1,'xf=',xf
!        write(*,*) 'CPU:',myid1,'xfz=',xfz
!        write(*,*) 'CPU:',myid1,'ix=',ix
...
c  BEGIN LOOP ON COMPLEXES
      do 3000 igs = 1, ngs1
       if(igs == myid1 + 1) then             !liqiang
       write(*,*) 'CPU:',myid1,'igs:',igs
       write(*,*) 'Enter the outer population:',igs         !liqiang
c
c  ASSIGN POINTS INTO COMPLEXES
      ...
      write(*,*) 'CPU:',myid1,cx(1,1),cx(2,1),cx(3,1)
!      write(*,*) 'CPU:',myid1,'ic=',ic
      write(*,*) 'CPU:',myid1,'cfq=',cfq
      write(*,*) 'CPU:',myid1,'cfzq=',cfzq
!      write(*,*) 'CPU:',myid1,'xfz=',xfz
      write(*,*) 'CPU:',myid1,'ic=',ic
c
...
c
   ...
   60   rand = ran1(iseed1)
     ...
     *         npg * (npg+1) * rand ))
      ...
      write(*,*) 'CPU:',myid1,'lcs=',(lcs(i),i=1,10)
c
...
c  CREATE THE SUB-COMPLEX ARRAYS
   85 do k = 1, nps
      ...
      write(*,*) 'CPU:',myid1,'cfq=',cfq
!      write(*,*) 'CPU:',myid1,'lcs=',lcs
!      write(*,*) 'CPU:',myid1,'ic=',ic
      write(*,*) 'CPU:',myid1,'is=',is
      write(*,*) 'CPU:',myid1,'sfz=',sfz
      write(*,*) 'CPU:',myid1,'sf=',sf
      write(*,*) 'CPU:',myid1,'s=',(s(i,1),i=1,4)
      write(*,*) 'CPU:',myid1,'iseed',iseed
      write(*,*) 'CPU:',myid1,'iiname',(iiname(i),i=1,10)
      write(*,*) 'CPU:',myid1,'iinr',(iinr(i),i=1,10)
      write(*,*) 'CPU:',myid1,'icalpar',icalpar
      write(*,*) 'CPU:',myid1,'isens',isens
      write(*,*) 'CPU:',myid1,'isenspar',isenspar
      write(*,*) 'CPU:',myid1,'imet',(imet(i),i=1,10)
      write(*,*) 'CPU:',myid1,'varobj',varobj
      write(*,*) 'CPU:',myid1,'omin',omin
      write(*,*) 'CPU:',myid1,'is',is
c 
...
!      write(*,*) 'CPU:',myid1,'s(1,1):',s(1,1),'s(2,1)=',s(2,1)
!      write(*,*) 'CPU:',myid1,'cfq=',cfq
!      write(*,*) 'CPU:',myid1,'lcs=',lcs
!      write(*,*) 'CPU:',myid1,'ic=',ic
      write(*,*) 'CPU:',myid1,'s=',(s(4,i),i=1,3)
c
...
!      write(*,*) 'CPU:',myid1,'ic=',ic
!      write(*,*) 'CPU:',myid1,'is=',is
      write(*,*) 'CPU:',myid1,'cx=',(cx(4,i),i=1,5) 
      write(*,*) 'CPU:',myid1,'xf=',xf
...
c  RECORD THE BEST AND WORST POINTS
      ...
      worstf = xf(npt1)
       ...
       write(*,*) 'CPU:',myid1,'bestf=',bestf
       write(*,*) 'CPU:',myid1,'worstf=',worstf
       write(*,*) 'CPU:',myid1,'bestx=',(bestx(i),i=1,5)
       write(*,*) 'CPU:',myid1,'worstx=',(worstx(i),i=1,5)
c
...
!      call mpi_barrier(mpi_comm_world, ierr)               ! liqiang
	call parasolunc2(iobj,igoc,nopt,icalml,istat, iprob,bbound,
     *	parname, ntot,omin,nobs,nintval, iiname, inrhru, iinr,
     *isens,icalpar, isenspar, sensw, imet)
