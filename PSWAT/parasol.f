...
!      open(18011,file='parasolout.out',status='unknown')
      str = 'parasolout.out'
      call create_files(str, 18011)
!      open(18012, file='sceobjf.out')
      str = 'sceobjf.out'
      call create_files(str, 18012)
!      open(18014, file='sceresponse.out')
      str = 'sceresponse.out'
      call create_files(str, 18014)
!      open(18013, file='scepar.out')
      str = 'scepar.out'
      call create_files(str, 18013)
!      open(18018, file='sceparobj.dat')
      str = 'sceparobj.dat'
      call create_files(str, 18018)
